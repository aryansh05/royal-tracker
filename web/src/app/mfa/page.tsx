    ...
    >
      ...
      >
        ...
        <input
          ...
          className="w-full p-3 rounded-xl bg-zinc-800/80 mb-4 outline-none focus:ring-2 focus:ring-purple-500 focus:shadow-[0_0_15px_rgba(168,85,247,0.8)] transition-all"
          value={code}
